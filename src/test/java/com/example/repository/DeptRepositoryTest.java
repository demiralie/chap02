...
public class DeptRepositoryTest {
   ...
   public void insert() {
      ...
      deptRepository.save(new Dept(new BigInteger("10"), "경리부x", "서울")); // save ==> insert , update
   ...
   public void update() {
      ...
      deptRepository.save(new Dept(new BigInteger("10"), "경리부y", "서울x"));
      
      System.out.println(deptRepository.findOne(new BigInteger("10")));
      
      assertEquals(new Dept(new BigInteger("10"), "경리부y", "서울x"), deptRepository.findOne(new BigInteger("10")));
   }
   ...
   public void selectAll2() {
      ...
      assertThat(deptRepository.findAll(), CoreMatchers.is(list));
